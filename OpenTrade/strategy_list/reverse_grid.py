...
class ReverseGrid(Strategy):
    def __init__(self, high_thresh, low_thresh, num_grids, inv_percent, max_open_positions, data, invesment, fee, name='ReverseGrid', method="ORDER-FUTURE"):
